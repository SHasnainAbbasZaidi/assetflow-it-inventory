...
import 'package:inventory_manager_flutter/views/scan_assignment_view.dart';
...
import 'package:inventory_manager_flutter/views/global_search_view.dart';
...
class _MainLayoutState extends State<MainLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
        ...
        child: Scaffold(
          floatingActionButton: !isDesktop && _currentIndex != 5
              ? FloatingActionButton.extended(
                  onPressed: () => setState(() => _currentIndex = 5),
                  icon: const Icon(Icons.qr_code_scanner),
                  label: const Text('Scan & assign'))
              : null,
          appBar: !isDesktop
              ? AppBar(
              ...
              ? BottomNavigationBar(
                  ...
                  items: const [
                    BottomNavigationBarItem(
                        ...
                        label: 'Dashboard'),
                    BottomNavigationBarItem(
                        icon: Icon(Icons.computer_rounded), label: 'Computers'),
                    BottomNavigationBarItem(
                        icon: Icon(Icons.mouse_rounded), label: 'Peripherals'),
                    BottomNavigationBarItem(
